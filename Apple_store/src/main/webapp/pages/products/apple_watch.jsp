    ...
    <div id="category">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">apple watch</li>
            </ol>
            <h1 class="h1">Apple Watch</h1>
            <div class="products">
                <div class="products-body">
                        ...
                        <div class="menu">
                            <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                    <a href="http://localhost:8080/Apple_store/applewatch" class="swiper-slide active">Tất cả</a>
                    ...
                    <div class="tab-pane">
                        <div class="product-list">
                            <c:forEach items="${listAppleWatch}" var="o" >
                        		<div class="product">
