            ...
            <div class="container">
                <div class="header-nav">
                    <div class="header-item">
                        <ul>
                            <li><a href="../products/iphone.jsp" class="nav-sub">iPhone</a></li>
                            <li><a href="../products/ipad.jsp" class="nav-sub">iPad</a></li>
                            <li><a href="../products/mac.jsp" class="nav-sub">Mac</a></li>
                            <li><a href="../products/apple_watch.jsp" class="nav-sub">Apple Watch</a></li>
                            <li><a href="../products/phu_kien.jsp" class="nav-sub">Phụ Kiện</a></li>
                            <li><a href="../products/#" class="nav-sub">Tin Tức - Thủ Thuật</a></li>
                        </ul>
