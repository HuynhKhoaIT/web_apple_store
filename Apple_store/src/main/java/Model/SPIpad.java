...
public class SPIpad {
	...
	public SPIpad(int maspipad, int madm, String tensp, String mota, int giaban, int giagoc, int soluong,
			String manhinh, String camerasau, String cameratruoc, String bonhotrong, String hedieuhanh, String cpu,
			String gpu, String xuatxu, String thoigianramat) {
		super();
		this.maspipad = maspipad;
		this.madm = madm;
		this.tensp = tensp;
		this.mota = mota;
		this.giaban = giaban;
	...
	public int getMaspipad() {
		return maspipad;
	}
	public void setMaspipad(int maspipad) {
		this.maspipad = maspipad;
	}
	public int getMadm() {
		return madm;
